...
const Vendor = require("../model/venderModel")
...
exports.addRide = async (req, res) => {
  try {
    ...
    // if (vendor.verification !== 'verified') { // Adjust verification check as per your schema
    //   return res.status(403).json({ success: 0, message: 'Vendor not verified' });
    // }
