...
//   try {
//     const vendor = await vender.findById(req.params.vendorId);
//     if (!vendor) {
//       return res.status(404).json({ success: 0, message: 'Vendor not found' });
//     }

//     vendor.verification = 'verified'; // Update this value according to your logic
//     await vendor.save();
//     res.status(200).json({ success: 1, message: 'Vendor verified successfully' });
//   } catch (error) {
