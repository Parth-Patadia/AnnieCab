...
export const Myvehicel = () => {
  ...
  const upload = async () => {
    ...
    if (
      ...
      setLoader(true);
      axios
        .post("https://sparkstoideas.daddy11.in/addVehicle/vehicleAdd", data)
        .then((res) => {
          console.log(res);
        ...
        {!open ? (
          ...
          <div className="bg-[#f3f3f1] p-4 w-full space-y-4">
            <div className="flex space-x-5">
              <div className="grid">
                <label className="font-medium mb-2">Vehicle Brand</label>
                <select
                  onChange={(e) => setKey(e.target.value)}
                  className="max-w-max"
                >
                  <option value={null} selected disabled={key}>
                    select
                  </option>
                  {brand.map((a, i) => {
                    return (
              ...
              {key && (
                <div className="grid">
                  <label className="font-medium mb-2">Vehicle Model</label>
                  <select
                    value={vehicleModel}
            ...
            {/* <div className='grid'>
                        ...
                        <div className='space-y-8 my-8'>
                            <div className='flex w-full justify-around'>
                                <div>
                                    <div onClick={e => inputRef1.current.click()} className='border-2 p-2 cursor-pointer bg-gray-300 w-full h-20 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed'>
                                ...
                                <div>
                                    <div onClick={e => inputRef2.current.click()} className='border-2 cursor-pointer bg-gray-300 w-full h-20 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed'>
                            ...
                            <div className='flex w-full justify-around'>
                                <div>
                                    <div onClick={e => inputRef3.current.click()} className='border-2 cursor-pointer bg-gray-300 w-full h-20 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed'>
                                ...
                                <div>
                                    <div onClick={e => inputRef4.current.click()} className='border-2 cursor-pointer bg-gray-300 w-full h-20 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed'>
            ...
            <div className="grid">
              <label className="font-medium mb-2">Vehicle Number</label>
              <input
                value={vehicleNumber}
            ...
            <div className="space-y-8 my-8">
              <div className="flex w-full justify-around">
                <div className="flex flex-col items-center">
                  <div
                    onClick={(e) => inputRef1.current.click()}
                    className="border-2 p-2 cursor-pointer bg-gray-200 w-full h-32 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed hover:bg-gray-300 transition"
                  >
                    <input
                      ref={inputRef1}
                    ...
                    {!vehicleImg ? (
                      ...
                      <img
                        className="w-full min-w-xs h-44 rounded-lg" alt=""
                        src={URL.createObjectURL(vehicleImg)}
                      />
                    )}
                  </div>
                ...
                <div className="flex flex-col items-center">
                  <div
                    onClick={(e) => inputRef2.current.click()}
                    className="border-2 p-2 cursor-pointer bg-gray-200 w-full h-32 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed hover:bg-gray-300 transition"
                  >
                    <input
                      ref={inputRef2}
                    ...
                    {!puc ? (
                      ...
                      <img
                        className="w-full min-w-xs h-44 rounded-lg" alt=""
                        src={URL.createObjectURL(puc)}
                      />
                    )}
                  </div>
                  <div className="text-center font-medium mt-2">PUC Image</div>
                </div>
              </div>
              <div className="flex w-full justify-around">
                <div className="flex flex-col items-center">
                  <div
                    onClick={(e) => inputRef3.current.click()}
                    className="border-2 p-2 cursor-pointer bg-gray-200 w-full h-32 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed hover:bg-gray-300 transition"
                  >
                    <input
                      ref={inputRef3}
                    ...
                    {!vehicleInsurance ? (
                      ...
                      <img
                        className="w-full min-w-xs h-44 rounded-lg" alt=""
                        src={URL.createObjectURL(vehicleInsurance)}
                      />
                    )}
                  </div>
                  <div className="text-center font-medium mt-2">
                ...
                <div className="flex flex-col items-center">
                  <div
                    onClick={(e) => inputRef4.current.click()}
                    className="border-2 p-2 cursor-pointer bg-gray-200 w-full h-32 rounded-lg max-w-sm grid place-items-center border-slate-700 border-dashed hover:bg-gray-300 transition"
                  >
                    <input
                      ref={inputRef4}
                    ...
                    {!vehicleRC ? (
                      ...
                      <img
                        className="w-full min-w-xs h-44 rounded-lg" alt=""
                        src={URL.createObjectURL(vehicleRC)}
                      />
                    )}
                  </div>
                  <div className="text-center font-medium mt-2">Vehicle RC</div>
                </div>
              </div>
            </div>
            <div className="text-center mt-8">
              <button
                onClick={upload}
                className="bg-green-500 font-medium p-4 w-120 max-w-md rounded-md hover:bg-green-600 transition"
              >
                Upload
              </button>
            </div>
